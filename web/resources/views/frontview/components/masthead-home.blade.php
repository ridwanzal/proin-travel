            ...
            <div class="col col-12 col-lg-6">
                <div class="text-left pt-5 pb-4">
                    ...
                    <small
                        ...
                        Proin Travel adalah penyedia jasa perjalanan ibadah Umroh & Haji yang Alhamdulillah dipercaya
                ...
                <div
                    ...
                    <a href="{{ url('#section-info') }}" class="btn btn-warning">Informasi Lengkap<i
                            class="animate__animated animate__fadeInUp bi bi-chevron-down ms-4"></i></a>
                </div>
            </div>
            <div class="col col-12 col-lg-6">
